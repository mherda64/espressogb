    ...
    public void add(Map<Integer, Instruction> instructions) {
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD %s, n", opcode.getTarget()))
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD A, %s", opcode.getTarget()))
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD B, %s", opcode.getTarget()))
                                .loadReg(opcode.getTarget())
                                .store(RegEnum.B)
                                .build(opcode.getCyclesFun()))
        );
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD C, %s", opcode.getTarget()))
                                .loadReg(opcode.getTarget())
                                .store(RegEnum.C)
                                .build(opcode.getCyclesFun()))
        );
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD D, %s", opcode.getTarget()))
                                .loadReg(opcode.getTarget())
                                .store(RegEnum.D)
                                .build(opcode.getCyclesFun()))
        );
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD E, %s", opcode.getTarget()))
                                .loadReg(opcode.getTarget())
                                .store(RegEnum.E)
                                .build(opcode.getCyclesFun()))
        );
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD H, %s", opcode.getTarget()))
                                .loadReg(opcode.getTarget())
                                .store(RegEnum.H)
                                .build(opcode.getCyclesFun()))
        );
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD L, %s", opcode.getTarget()))
                                .loadReg(opcode.getTarget())
                                .store(RegEnum.L)
                                .build(opcode.getCyclesFun()))
        );
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD %s, (HL)", opcode.getTarget()))
                                .loadReg(RegEnum.HL)
                                .loadAddress()
                                .store(opcode.getTarget())
                                .build(opcode.getCyclesFun()))
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD (HL), %s", opcode.getTarget()))
                                .loadReg(opcode.getTarget())
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        instructions,
                        Instruction.builder()
                                .label(String.format("LD %s, A", opcode.getTarget()))
                                .loadReg(RegEnum.A)
                                .store(opcode.getTarget())
                                .build(opcode.getCyclesFun()))
        );
        ...
        Stream.of(
                ...
                put(opcode.getOpcode(),
                        ...
                        Instruction.builder()
                                .label(String.format("LD (%s), A", opcode.getTarget()))
                                .loadReg(RegEnum.A)
                                .storeRegAddressAccumulator(opcode.getTarget())
                                .build(opcode.getCyclesFun()))
        );
